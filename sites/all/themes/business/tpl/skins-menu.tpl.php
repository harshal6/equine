...
$skins = business_get_predefined_param('skins', array("default" => t("Default Style")));
...
$layouts = business_get_predefined_param('layout', array("layout-default" => t("Default Layout")));
